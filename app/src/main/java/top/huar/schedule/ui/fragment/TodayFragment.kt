...
import top.huar.schedule.ui.adapter.TodayRecyclerViewAdapter
...
class TodayFragment : Fragment() {
    ...
    private fun setViewProgress() {
        ...
        if (viewProgress != null) {
            val display = (Objects.requireNonNull(Objects.requireNonNull(requireContext()).getSystemService(Context.WINDOW_SERVICE)) as WindowManager).defaultDisplay
            val size = Point()
