...
import top.huar.schedule.receiver.RemindReceiver
import top.huar.schedule.ui.activity.MainActivity
import top.huar.schedule.ui.fragment.setting.SettingsFragment
import top.huar.schedule.ui.fragment.setting.SettingsFragment.Companion.CLASS_REMINDER_DOWN_TIME
import top.huar.schedule.ui.fragment.setting.SettingsFragment.Companion.CLASS_REMINDER_UP_TIME
import top.huar.schedule.ui.fragment.setting.SettingsFragment.Companion.FOREGROUND_SERVICE_STATUS
import top.huar.schedule.ui.fragment.setting.SettingsFragment.Companion.PHONE_MUTE_AFTER_TIME
import top.huar.schedule.ui.fragment.setting.SettingsFragment.Companion.PHONE_MUTE_BEFORE_TIME
import top.huar.schedule.ui.fragment.setting.SettingsFragment.Companion.PHONE_MUTE_STATUS
...
class RemindService : Service(), SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    private fun sendNotification(contentTitle: String, contentText: String) {
        ...
        val builder = NotificationCompat.Builder(this, "class_reminder")
                ...
                .setSmallIcon(R.mipmap.icon_class)
